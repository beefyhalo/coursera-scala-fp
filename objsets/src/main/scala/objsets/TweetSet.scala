...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = {
    var x = elem
    val f = { tweet: Tweet => if (tweet.retweets > x.retweets) x = tweet }
    left foreach f
    right foreach f
    x
  }
...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = TweetReader.allTweets filter { google exists _.text.contains }
  lazy val appleTweets: TweetSet  = TweetReader.allTweets filter {  apple exists _.text.contains }
